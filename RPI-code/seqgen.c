...
{
    struct timeval current_time_val;
    struct timespec delay_time = {0,33333333}; // delay for 33.33 msec, 30 Hz For Q1
...
void *Service_1(void *threadp)
{
    struct timeval current_time_val, temp_time, start_time;
    double current_time;
    ...
    while(!abortS1)
    {
        ...
        syslog(LOG_CRIT, "Frame Sampler start %llu @ sec=%d, usec=%d\n", S1Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        int i, j;
        for(i=0; i<1000; i++)
            {j++;}
        S1Cnt++;
                
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, "Frame Sampler WCET1 %llu @ sec=%d, usec=%d\n", S1Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_2(void *threadp)
{
    ...
    while(!abortS2)
    {
        sem_wait(&semS2);
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S2Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        int i, j;
        for(i=0; i<1000; i++)
           {j++;}
        S2Cnt++;
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET2 %llu @ sec=%d, usec=%d\n", S2Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_3(void *threadp)
{
    ...
    while(!abortS3)
    {
        sem_wait(&semS3);
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S3Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        int i, j;
        for(i=0; i<1000; i++)
           {j++;}
        S3Cnt++;
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET3 %llu @ sec=%d, usec=%d\n", S3Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_4(void *threadp)
{
    ...
    while(!abortS4)
    {
        ...
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S4Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        int i, j;
        for(i=0; i<1000; i++)
           {j++;}
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET4 %llu @ sec=%d, usec=%d\n", S4Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_5(void *threadp)
{
    ...
    while(!abortS5)
    {
        sem_wait(&semS5);
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S5Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET5 %llu @ sec=%d, usec=%d\n", S5Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_6(void *threadp)
{
    ...
    while(!abortS6)
    {
        sem_wait(&semS6);
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S6Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET6 %llu @ sec=%d, usec=%d\n", S6Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
...
void *Service_7(void *threadp)
{
    ...
    while(!abortS7)
    {
        sem_wait(&semS7);
        gettimeofday(&start_time, (struct timezone *)0);
        syslog(LOG_CRIT, " start %llu @ sec=%d, usec=%d\n", S7Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec);
        int i, j;
        for(i=0; i<1000; i++)
           {j++;}
        S7Cnt++;
        ...
        gettimeofday(&temp_time, (struct timezone *)0);
        syslog(LOG_CRIT, " WCET7 %llu @ sec=%d, usec=%d\n", S7Cnt, (int)(temp_time.tv_sec-start_time.tv_sec), (int)(temp_time.tv_usec- start_time.tv_usec));
